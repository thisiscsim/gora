  ...
  export default function Portfolio() {
    return (
      <section className="space-y-4">
        <h2 className="text-xs tertiary-text">Portfolio</h2>
        <div className="space-y-2">
          {portfolioItems.map((item, index) => (
            <div key={index} className={`flex justify-between items-center py-4 border-t border-[var(--border)] ${
                index === portfolioItems.length - 1 ? "border-b" : ""
              }`}>
